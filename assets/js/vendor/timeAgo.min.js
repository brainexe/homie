...
angular.module('yaru22.angular-timeago', [
	...
	service.inWordsShort = function (distanceMillis) {
	...
	service.inWords = function (distanceMillis) {
		var ago = service.inWordsShort(distanceMillis);
...
}).filter('timeAgoShort', function (nowTime, timeAgo) {
	return function (value) {
		var fromTime = timeAgo.parse(value);
		var diff = nowTime() - fromTime;
		return timeAgo.inWordsShort(diff);
	};
});
