...
App.service('controllers', ['_', function(_) {
    return function() {
        return [
            ...
            {controller:'DisplaysController', name: _('Displays'), url: 'displays', icon:'text-background', templateUrl: '/templates/displays.html'},
            {controller:'EspeakController', name: _('Speak'), url: 'speak', icon:'bullhorn', templateUrl: '/templates/espeak.html'},
            {controller:'EggTimerController', name: _('Egg Timer'), url: 'egg_timer', icon:'time', templateUrl: '/templates/egg_timer.html'},
            {controller:'TodoController', name: _('ToDo List'), url: 'todo', icon:'list', templateUrl: '/templates/todo.html'},
            {controller:'ShoppingListController', name: _('Shopping List'), url: 'shopping', icon:'list', templateUrl: '/templates/shopping_list.html'},
            {controller:'WebcamController', name: _('Webcam'), url: 'camera', icon:'bullhorn', templateUrl: '/templates/webcam.html'},
