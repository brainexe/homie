...
App.service("controllers", ["_", function(_) {
    return () =>
        [
            ...
            {controller:'EspeakController',       name: _('Speak'),         url: 'speak',         icon:'bullhorn',  templateUrl: '/templates/espeak/index.html',              collapsible:true},
            {controller:'EggTimerController',     name: _('Egg Timer'),     url: 'egg_timer',     icon:'time',      templateUrl: '/templates/eggTimer/index.html',            collapsible:true},
