...
(composer update --prefer-dist --no-dev -o && php console cc && echo "updated composer + backend caches")

(cd nodejs && NODE_ENV=production npm install --production && echo "updated nodejs")
